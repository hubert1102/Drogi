...
/** @brief Sprawdza, czy nazwa @p city jest poprawną nazwą miasta.
 *
 * @param [in] city     - napis.
 * @return Zwraca true, jeżeli @p city jest poprawnym napisem.
 * Zwraca @p false w przeciwnym wypadku.
 */
bool valid_city(const char* city);

/** @brief Sprawdza, czy może powstać odcinek drogi powiędzy miastami o nazwach
 * @p city1 i @p city2.
 ...
 * @return Zwraca @p true, jeżeli można dodać odcinek drogi pomiędzy miastami
 * o nazwach @p city1 i @p city2. Zwraca @p false w przeciwnym wypadku.
 */
...
/** @brief Sprawdza, czy może powstać droga krajowa pomiędzy dwoma miastami.
 * @param map
 * @param city1
 * @param city2
 * @return Zwraca @p false jeżeli nie istnieje któreś z podanych miast,
 * lub oba napisy są takie same. Zwraca @p true w przeciwnym wypadku.
 */
